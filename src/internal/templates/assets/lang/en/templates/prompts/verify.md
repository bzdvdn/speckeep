...
- Evidence format: list `T* -> proof` lines (and `AC-* -> T*` when relevant). Proof must be something observable: changed file path, test name/output, command output, or a documented artifact.
