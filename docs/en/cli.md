...
- migrating flat spec artifacts (`specs/<slug>.md`) to the canonical directory layout (`specs/<slug>/spec.md`)
- migrating plan artifacts from the old `plans/<slug>/` layout to `specs/<slug>/plan/`
